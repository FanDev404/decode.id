...
const createServersV1 = async (url, options = { application_key: "", username: "", servername = "", first_name: "", last_name: "", password: "", email: "", isAdmins: false, id: 1, egg: 16, locations: 1, create: "1GB" }) => {
    const results = { status: false, data: {}, message: "" }
    if (!options?.application_key || options?.application_key && !options?.application_key.startsWith("ptla_")) {
        results.message = "Invalid key"
        return results
